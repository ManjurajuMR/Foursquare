...
class ToppickAdapter(/*private var arrayList : List<>,*/ private val clickListener: OnToppickItemClickListener) : RecyclerView.Adapter<ToppickAdapter.ViewHolder>() {

    inner class ViewHolder(view : View, private val onClickListener: OnToppickItemClickListener) : RecyclerView.ViewHolder(view), View.OnClickListener{
        ...
        override fun onClick(p0: View?) {
            onClickListener.onToppickClick(adapterPosition)
        }
    ...
    interface OnToppickItemClickListener {
        fun onToppickClick( position: Int)
    }
