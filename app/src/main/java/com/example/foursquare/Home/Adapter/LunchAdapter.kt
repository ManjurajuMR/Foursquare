...
class LunchAdapter(/*private var arrayList : List<>,*/ private val clickListener: OnLunchItemClickListener) : RecyclerView.Adapter<LunchAdapter.ViewHolder>() {

    inner class ViewHolder(view : View, private val onClickListener: OnLunchItemClickListener) : RecyclerView.ViewHolder(view), View.OnClickListener{
        ...
        override fun onClick(p0: View?) {
            onClickListener.onLunchClick(adapterPosition)
        }
    ...
    interface OnLunchItemClickListener {
        fun onLunchClick( position: Int)
    }
